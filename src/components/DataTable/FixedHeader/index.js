...
const FixedHeader = ({columns, table_size, columns_sizes}) => {


  return (
    <Table striped unstackable className='fixed-header-table' style={{width: `${table_size ? table_size.entry.width : 0}px`}}>
      <Table.Header>
        <Table.Row>
          {columns.map( (c, i) =>
